export interface SimulatedSentimentVolumeDatum {
  volume: number;
  neutro: number;
  positivo: number;
  negativo: number;
...
export interface SimulatedTopicMentionsDatum {
  mes: string;
  saude: number;
  beneficios: number;
}

export interface SimulatedEntitySourceDistributionDatum {
  nome: string;
  instagram: number;
  facebook: number;
  portais: number;
...
export const SIMULATED_SENTIMENT_VOLUME_BY_WINDOW: SimulatedSentimentVolumeDatum[] = [
...
export const SIMULATED_TOPIC_MENTIONS_TIMELINE: SimulatedTopicMentionsDatum[] = [
...
export const SIMULATED_ENTITY_SOURCE_DISTRIBUTION: SimulatedEntitySourceDistributionDatum[] = [
